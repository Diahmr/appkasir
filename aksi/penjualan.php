...
if($_POST){
    if($_POST['aksi']=='tambah-keranjang-bybarcode'){
        ...
        if(mysqli_query($koneksi,$sql1)){
            //echo "Simpan penjualan suskses";
            // mengambil penjualan dari tabel penjualan
            ...
            // menyimpan data produk yang dibeli ke tabel detail penjualan yg diambil dari tabel keranjang
