...
$pdf->setKeywords('App Kasir, Penjualan');
...
<table style="widht:100%; border-collapse:collapse; border: 1px solid black;" border="1">
    <tr style="font-weight:bold; text-align:center;">
        ...
        <td style="width:15%;">ID Penjualan</td>
        <td style="width:30%;">Tanggal Penjualan</td>
        <td style="width:30%;">Pelanggan</td>
        <td style="width:20%;">Total Belanja</td>
    </tr>

';

$sql="SELECT penjualan.*,pelanggan.NamaPelanggan FROM penjualan,pelanggan WHERE penjualan.PelangganID=pelanggan.PelangganID AND TanggalPenjualan BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY penjualan.TanggalPenjualan ASC"; //between itu di antara tanggal awal dan ahkir/ ASC dri kecil kebesar / DSC dri besar ke kecil
