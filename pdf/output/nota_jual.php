...
<table style="width:100%">
    <tr>
        <td styles="width:25%">No Transaksi</td>
        <td styles="width:25%">: '.$penjualan['PenjualanID'].'</td>
        <td styles="width:25%">No Transaksi</td>
        <td styles="width:25%">: '.$penjualan['TanggalPenjualan'].'</td>
    </tr>
    <tr>
        <td styles="width:25%">Nama Pelanggan</td>
        <td styles="width:25%">: '.$penjualan['NamaPelanggan'].'</td>
        <td styles="width:25%">Total Belanja</td>
        <td styles="width:25%">: Rp.'.number_format($penjualan['TotalHarga']).'</td>
    </tr>
</table>
<br><br>
